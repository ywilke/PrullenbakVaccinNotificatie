...
def format_message(entry, loc):
    ...
    U wordt afgeraden om naar de prik locatie te gaan als u niet binnen 10-20 minuten na ontvangen van deze mail ter plaatse kan zijn. <b>Als u naar de locatie gaat vergeet dan niet:</b>
    <ul>
